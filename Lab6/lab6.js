...
const pw1 = document.getElementById("contra1");  
const pw2 = document.getElementById("contra2");
const boton = document.getElementById("checar");
boton.addEventListener("click",verificarPswd);

function verificarPswd() {   
    if(pw1.value == pw2.value) {   
        alert("Password creada con exito");  
    } 
    else {  
